...
public class HandyManActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_handy_man);
        ...
        agentPostRecyclerAdapter = new AgentPostRecyclerAdapter(post_list, HandyManActivity.this);
        ...
        firebaseFirestore.collection("Posts").whereEqualTo("category", "Handyman").limit(5).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
        ...
        Query mQuery = firebaseFirestore.collection("Posts").whereEqualTo("category", "Handyman");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(HandyManActivity.this, MainActivity.class);
        startActivity(intent);
        finish();
    ...
    private void loadMorePosts() {
        firebaseFirestore.collection("Posts").whereEqualTo("category", "Handyman").startAfter(lastVisible).limit(5).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(QuerySnapshot queryDocumentSnapshots, FirebaseFirestoreException e) {
                if (!queryDocumentSnapshots.isEmpty()) {
                    lastVisible = queryDocumentSnapshots.getDocuments().get(queryDocumentSnapshots.size() -1);
