...
public class LeaseActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agentPostRecyclerAdapter = new AgentPostRecyclerAdapter(post_list, LeaseActivity.this);
        ...
        firebaseFirestore.collection("Posts").whereEqualTo("category", "Lease").limit(5).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
        ...
        Query mQuery = firebaseFirestore.collection("Posts").whereEqualTo("category", "Lease");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(LeaseActivity.this, MainActivity.class);
        startActivity(intent);
        finish();
    ...
    private void loadMorePosts() {
        firebaseFirestore.collection("Posts").whereEqualTo("category", "Lease").startAfter(lastVisible).limit(5).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(QuerySnapshot queryDocumentSnapshots, FirebaseFirestoreException e) {
                if (!queryDocumentSnapshots.isEmpty()) {
                    lastVisible = queryDocumentSnapshots.getDocuments().get(queryDocumentSnapshots.size() -1);
